...
router.route('/api/products').get(productController.list).post(productController.create);

router.route('/api/products/:productId').get(productController.read).put(productController.update).delete(productController.remove);
